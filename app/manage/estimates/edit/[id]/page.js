...
export default function EstimateEditPage() {
  ...
  const calculateEstimateValues = (estimateData) => {
    ...
    const vatRate =
      (paymentInfo.vatRate !== undefined && paymentInfo.vatRate !== null
        ? paymentInfo.vatRate
        : 10) / 100;
    let vatAmount = 0;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 키워드 파라미터가 있으면 상세 페이지로 이동할 때도 유지
      const keywordParam = searchParams.get('keyword');
      if (keywordParam) {
        router.push(`/manage/estimates/detail/${id}?keyword=${encodeURIComponent(keywordParam)}`);
      } else {
          ...
          <div className="bg-white p-4 rounded-lg shadow mb-2">
            ...
            {estimate.customerInfo?.content && (
              <div className="mb-3">
                ...
                <textarea
                  ...
                  value={
                    estimate.customerInfo?.content !== null &&
                    estimate.customerInfo?.content !== undefined
                      ? estimate.customerInfo.content
                      : ''
                  }
            ...
            <div className="mt-2">
              ...
              <textarea
                ...
                value={
                  estimate.estimateDescription !== null &&
                  estimate.estimateDescription !== undefined
                ...
                onBlur={handleBlur}
                rows={focusedInput === 'estimateDescription' ? 30 : 4}
          ...
          {showNotesModal && (
            <div className="fixed bottom-10 right-20 bg-white rounded-lg p-4 w-80 shadow-xl z-50 border border-gray-200">
              ...
              <textarea
                ...
                value={
                  estimate?.notes !== null && estimate?.notes !== undefined ? estimate.notes : ''
                }
