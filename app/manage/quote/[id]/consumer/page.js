  ...
  useEffect(() => {
    const fetchEstimate = async () => {
      try {
        ...
        // API를 통해 견적 데이터 불러오기 (인증 없는 API 엔드포인트 사용)
          ...
          <div className="border border-sky-200 rounded-lg px-2 mb-2 bg-sky-50">
            ...
            <div className="space-y-1">
              ...
              <div className="flex gap-1 items-center">
                ...
                {/* 최종 결제 금액 */}
                <div className="border-2 border-sky-500 rounded-md p-3 bg-sky-200 from-sky-100 to-sky-200 flex-[1.6] flex justify-between items-center font-bold shadow-md relative overflow-hidden">
