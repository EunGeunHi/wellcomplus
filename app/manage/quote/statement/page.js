        ...
        <div className="bg-yellow-100 p-4 mb-4 border-l-4 border-yellow-500 rounded shadow-md">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li className="text-yellow-700">
              <span className="font-semibold">날짜:</span> 오늘 날짜가 자동으로 들어가고, 직접
              수정도 가능합니다.
            </li>
            <li className="text-yellow-700">
            ...
            <div className="border border-blue-500 p-4">
              ...
              <table className="w-full border-collapse text-xs">
                <thead className="text-xs text-blue-600">
                  <tr>
                    <th
                      className="border border-blue-500 p-0.5 bg-gray-100"
                      style={{ width: '4%' }}
                    >
                      번호
                    </th>
                  ...
                  <tr>
                    ...
                    <td className="border border-red-500 p-0.5">
                      <div className="flex items-center">
                        ...
                        />
                        <div className="relative">
                          <span className="text-[9px] text-red-600 mr-1 whitespace-nowrap">
                            (인)
                          </span>
                          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                            <img
              ...
              <table className="w-full border-collapse text-xs">
                <thead className="text-xs text-red-600">
                  <tr>
                    ...
                    <th
                      className="border border-red-500 p-0.5 bg-gray-100"
                      style={{ width: '40%' }}
                    >
                      상
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;품
