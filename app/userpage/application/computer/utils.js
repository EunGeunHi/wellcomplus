...
export const validateForm = (formData) => {
  ...
  if (missingFields.length > 0) {
    errors.push('사용목적(용도), 예산, 운영체제, 연락처는 필수로 작성해야 합니다.');
  }
...
export const logFormData = (formData, selectedFiles, formatFileSize) => {
  ...
  console.log('메모리:', formData.memory || '선택안함');
  console.log('SSD/HDD(저장 용량):', formData.storage || '선택안함');
  console.log('쿨러/튜닝:', formData.cooling || '선택안함');
  console.log('운영체제:', formData.os);
